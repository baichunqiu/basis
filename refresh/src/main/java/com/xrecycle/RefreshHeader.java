...
public class RefreshHeader extends LinearLayout implements IRefreshHeader,Indicator{
	...
	private void initView() {
        ...
        ((View) indicatorView).setVisibility(VISIBLE);
        if(mProgressBar != null) mProgressBar.setView((View) indicatorView);
