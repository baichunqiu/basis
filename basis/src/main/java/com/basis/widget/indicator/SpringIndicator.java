...
public class SpringIndicator extends FrameLayout {
    ...
    private void initAttrs(AttributeSet attrs){
        ...
        indicatorColorId = R.color.color_basis_bg;
        textSize = getResources().getDimension(R.dimen.font_18sp);
        radiusMax = getResources().getDimension(R.dimen.dimens_45px);
        radiusMin = getResources().getDimension(R.dimen.dimens_15px);
